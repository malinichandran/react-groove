...
router.get("/:username/:playlist_name", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
router.patch("/:playlist_name", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
router.delete("/:playlist_name", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
router.post("/:username/:playlist_name", ensureCorrectUser, async function (
  req,
  res,
  next
) {
...
router.delete(
  "/:username/:playlist_name/:videoId",
  ensureCorrectUser,
...
router.get("/edit/getdata/:playlist_name", ensureCorrectUser, async function (
  req,
  res,
  next
) {
